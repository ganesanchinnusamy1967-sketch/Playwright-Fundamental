...
Call log:
  - waiting for getByRole('radio', { name: 'gender', exact: true })
          ...
          - generic [ref=e245]:
            ...
            - generic [ref=e247]:
              ...
              - generic [ref=e258]:
                ...
                - textbox "Last name" [active] [ref=e260]:
                  - /placeholder: Sharma
                  - text: Kandhan
                - generic [ref=e261]:
                  - generic [ref=e262]:
...
> 6  |     await page.getByRole("radio", { name: 'gender', exact: true }).check();
     |                                                                    ^ TimeoutError: locator.check: Timeout 60000ms exceeded.
  7  | 
  8  |     await page.getByTestId("years-experience").selectOption("7");
  9  |     await page.getByTestId("profile-date").fill("2016-05-11");
  10 |     await page.getByRole("radio", { name: 'profession' , exact: true}).check();
  11 | 
  12 | 
  13 | 
  14 | });
