...
- Name: project_06.spec.ts >> fill the QA Profile form
- Location: tests\project_06.spec.ts:2:5

# Error details

```
TimeoutError: locator.check: Timeout 60000ms exceeded.
Call log:
  - waiting for getByTestId('tool-uft ')
          ...
          - generic [ref=e280]:
            ...
            - generic [ref=e282]:
              ...
              - generic [ref=e293]:
                ...
                - textbox "Date" [ref=e295]: 2016-05-11
                - generic [ref=e296]:
                  - generic [ref=e297]:
                    - generic [ref=e298]: id
                    - text: =profile-date
            ...
            - generic [ref=e303]:
              ...
              - radiogroup "Profession" [ref=e305]:
                ...
                - generic [ref=e308] [cursor=pointer]:
                  - radio "Automation Tester" [checked] [active] [ref=e309]
...
```ts
  ...
  2  | test('fill the QA Profile form',async({page})=>{
  3  |     await page.goto('https://app.thetestingacademy.com/playwright/tables/practice#page');
  4  |     await page.locator("#first-name").fill("Murugan");
  5  |     await page.locator("#last-name").fill("Kandhan");
  6  |     await page.getByTestId('gender-male').check();
  7  | 
  8  |     await page.getByTestId("years-experience").selectOption("7");
  9  |     await page.getByTestId("profile-date").fill("2016-05-11");
  10 |     await page.getByTestId("profession-automation").check();
  11 | 
> 12 |     // Select the Profession as Automation Tester
     |                                         ^ TimeoutError: locator.check: Timeout 60000ms exceeded.
  13 |     await page.getByRole('radio', { name: 'Automation Tester' }).check();
  14 | 
  15 |     await page.getByTestId("tool-uft ").check();
  16 | 
  17 |     await page.getByTestId('continent-asia').check();
  18 |     await page.getByTestId('continent-europe').check();
  19 | 
  20 | 
  21 |     await page.getByTestId("tab-browser").click();
  22 | 
  23 |     await page.locator("#upload-image · download-file").setInputFiles("C:\\Users\Pictures\Screenshots");
  24 |     await page.getByTestId("profile-submit").click();
  25 | 
  26 | 
  27 | 
  28 | });
